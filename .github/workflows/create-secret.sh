...
gh secret set GIT_PAT --env k8s-dev --body "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"
gh secret set GH_PAT --env k8s-dev --body "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"